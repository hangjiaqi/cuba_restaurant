...
public class RestaurantTestContainer extends TestContainer {

    public RestaurantTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/restaurant/app.properties",
    ...
    public static class Common extends RestaurantTestContainer {

        public static final RestaurantTestContainer.Common INSTANCE = new RestaurantTestContainer.Common();
